...
The project covers data cleaning, exploratory data analysis, statistical analysis, outlier treatment, correlation analysis, data visualization, and data-driven recommendations to identify engagement patterns and factors associated with high-performing posts.
...
* Examine media usage and verification status.
...
Instead of deleting observations, **IQR-based capping** was applied to reduce the influence of extreme values while preserving the dataset.
...
Multiple visualizations were created to communicate the findings effectively, including:
...
Different content formats were analyzed to understand their relationship with engagement.
...
Engagement rates were analyzed by posting hour to identify potentially stronger-performing posting periods.
...
Verified and non-verified accounts, as well as posts with and without media, were analyzed for differences in engagement.

### High-Performing Posts

Posts with high engagement rates were examined to identify common characteristics and potential engagement patterns.
...
The analysis of high-performing posts helps identify patterns that can support future content planning and engagement strategies.
...
**Project Video:**
https://drive.google.com/file/d/186G6H7sZyVSKTebipCdM5cpcOUOt5ywV/view?usp=sharing
...
https://github.com/gamepatt78/Social_Media_Analytics

### LinkedIn Project Post

https://lnkd.in/p/gCRBhPtT
